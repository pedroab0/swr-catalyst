  ...
  return (
    <section className="panel note">
      ...
      <ol>
        ...
        <li>
          Run create/update/delete in Hooks Demo and watch optimistic UI.
        </li>
        <li>
          Use <code>Validation errors</code> for failure handling or set
          failure mode to <code>network</code> manually.
        </li>
        <li>
